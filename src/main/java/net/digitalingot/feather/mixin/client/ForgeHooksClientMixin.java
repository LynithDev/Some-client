...
public class ForgeHooksClientMixin
{
    ...
    public static int getSkyBlendColour(final World world, final BlockPos blockPos) {
        if (blockPos.getX() == ForgeHooksClientMixin.skyX && blockPos.getZ() == ForgeHooksClientMixin.skyZ && ForgeHooksClientMixin.skyInit) {
            return ForgeHooksClientMixin.skyRGBMultiplier;
        }
        ForgeHooksClientMixin.skyInit = true;
        ...
        ForgeHooksClientMixin.skyX = blockPos.getX();
        ForgeHooksClientMixin.skyZ = blockPos.getZ();
        return ForgeHooksClientMixin.skyRGBMultiplier = skyRGBMultiplier;
    }
}
