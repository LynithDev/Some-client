...
public abstract class SplashProgressThreadMixin implements Runnable
{
    ...
    private void c(final CallbackInfo callbackInfo) {
        ...
        while (true) {
            ...
            else if (SplashProgressAccessorMixin.isDone()) {
                n3 = 212;
                n4 = frameCount;
                n = n3 - 1;
                n2 = 1;
            ...
            GL11.glDisable(3553);
            SplashProgressAccessorMixin.getMutex().acquireUninterruptibly();
            Display.update();
            SplashProgressAccessorMixin.getMutex().release();
            if (SplashProgressAccessorMixin.isPaused()) {
                this.clearGL();
                this.setGL();
            }
            Display.sync(100);
