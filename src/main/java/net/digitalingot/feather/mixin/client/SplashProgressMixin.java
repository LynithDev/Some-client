...
public abstract class SplashProgressMixin
{
    ...
    private static void ensureEnabled(final CallbackInfo callbackInfo) {
        SplashProgressMixin.enabled = true;
    }
    ...
    private static void cancelTextureDelete(final CallbackInfo callbackInfo) {
        callbackInfo.cancel();
    }
}
